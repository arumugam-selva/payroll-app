...
import com.genqube.internal.hr.domain.Employee;
import com.genqube.internal.hr.repository.EmployeeRepository;
import com.genqube.internal.hr.service.EmployeeService;
...
public class EmployeeResourceIT {
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getOrg()).isEqualTo(DEFAULT_ORG);
    ...
    public void updateEmployee() throws Exception {
        ...
        Employee testEmployee = employeeList.get(employeeList.size() - 1);
        assertThat(testEmployee.getOrg()).isEqualTo(UPDATED_ORG);
